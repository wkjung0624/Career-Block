<template>
    <div class="box-container">
        <h1 style="color:white; text-align:left; padding-left:25px; padding-top:20px;">약관동의</h1>
        <div>
            <table class="tb">
            <tr style="height:10%; border-bottom: solid 1px gainsboro;">
                <td class="td1">전체동의<input type="checkbox" name="" id="" class="chk"></td>
            </tr>
            <tr style="height:8%;">
                <td class="td1">서비스 이용약관 동의 (필수)<input type="checkbox" name="" id="" class="chk2"></td>
            </tr>
            <tr style="height:37%;">
                <td><textarea name="" id="" class="txa1" readonly>제 1 조 (회사의 의무)
...
본 사이트 이용 및 행위가 다음 각 항에 해당하는 경우 회사는 해당 이용자의 이용을 제한할 수 있다.
             ...
             <tr style="height:8%;">
                <td class="td1">개인정보 수집 및 이용 동의 (필수)<input type="checkbox" name="" id="" class="chk3"></td>
            </tr>
             <tr style="height:37%;">
                <td><textarea name="" id="" class="txa1" readonly>개인정보보호법에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
...
- 콘텐츠 등 기존 서비스 제공(광고 포함)에 더하여, 인구통계학적 분석, 서비스 방문 및 이용기록의 분석, 개인정보 및 관심에 기반한 이용자간 관계의 형성, 지인 및 관심사 등에 기반한 맞춤형 서비스 제공 등 신규 서비스 요소의 발굴 및 기존 서비스 개선 등을 위하여 개인정보를 이용합니다.</textarea></td>
            </tr>
            </table>
        </div>
        <br>
...
.chk {
    position:relative; left:350px; top:4px;
    width: 20px;
    height: 20px;
}

.chk2 {
    position:relative; left:217px; top:4px;
    width: 20px;
    height: 20px;
}
