    ...
    <body id="page-top">
      ...
      >
        <div class="container px-4 px-lg-5">
          <a class="navbar-brand fs-2" href="#page-top" @click="changePage(0)"
            >Career Block</a
          >
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
              <li class="nav-item">
                <a class="nav-link fs-5" href="#services" @click="changePage(0)"
                  >About</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link fs-5" href="#about" @click="changePage(0)"
                  >Services</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link fs-5" href="#myresume" @click="changePage(1)"
                  >Resume</a
                >
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <div class="input-group input-group-sm">
                  <input
                    ...
                    class="form-control"
                    v-model="searchQuery"
                    aria-label="Search Resume with Keys"
                    placeholder="Search Resume with Keys"
                    aria-describedby="inputGroup-sizing-sm"
                    @keydown.enter="searchResume()"
                  />
                  <span class="input-group-text" id="inputGroup-sizing-sm">
                    <img
                      src="./assets/img/search_black_24dp.svg"
                      style="height: 22px"
                      @click="searchResume()"
                    />
                  </span>
              ...
              <li class="nav-item">
                <div
                  class="input-group btn-group-sm"
                  role="group"
      ...
      <div v-if="pageIndex == 0">
            ...
            >
              <div class="col-lg-8 align-self-end">
                <h1 class="text-white font-weight-bold">
                  <!-- Manage your Resume with a Career Block for Free -->
                  Manage Your Career
                </h1>
                <br />
                <hr class="divider" />
        ...
        <section class="page-section" id="services">
          <div class="container px-4 px-lg-5">
            <h2 class="text-center mt-0">Philosophy</h2>
            <hr class="divider" />
            <div class="row gx-4 gx-lg-5">
              <div class="col-lg-3 col-md-6 text-center">
                <div class="mt-5">
                  <div class="mb-2">
                    <i class="bi-suit-club fs-1 text-primary"></i>
                  </div>
              ...
              <div class="col-lg-3 col-md-6 text-center">
                <div class="mt-5">
                  <div class="mb-2">
                    <i class="bi-check2-square fs-1 text-primary"></i>
                  </div>
        ...
        <!-- <section class="page-section bg-dark text-white">
          <div class="container px-4 px-lg-5 text-center">
              <h2 class="mb-4">Career Block</h2>
              <a class="btn btn-success btn-xm" style="margin-right:10px" href="/">Sign in</a>
              <a class="btn btn-light btn-xm" style="margin-left:10px" href="/">Sign up</a>
          </div>
      </section> -->
          ...
          <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
              <div class="col-lg-8 text-center">
                ...
                <a class="btn btn-light btn-xl fs-6" href="#services"
                  >Get Started!</a
                >
              </div>
            </div>
        ...
        <footer class="bg-light py-5">
          <div class="container px-4 px-lg-5">
            <div class="small text-center text-muted">
              Copyright &copy; 2021 - Career Block
            </div>
          </div>
        </footer>
      </div>
...
export default {
  ...
  methods: {
    ...
    logbtn(param) {
      param
        ? this.load_components[0].kakaoLogin()
